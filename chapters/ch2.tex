...
\begin{proof}
    ...
    收敛到0.由$f$的$C^2$正则性,可得当$N\to \infty$,$\mathbb{E}[f(\bar{\mu}^N_s)]\to f(\mu)$.\par
    \textbf{第二步}:\par
    这一步证明去掉对$f$及其导数的有界性和一致连续性后,公式(3.15)仍然成立.首先我们承认以下引理:
...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
由于$X$二阶矩有限,所以当$n\to \infty$,$W_2(\mu\circ\rho_n^{-1},\mu)\to 0$.结合连续性可得
\end{proof}